...
engine3D.initSunlight = function () {
    ...
    */
    if (json.weather.sunlight) {
        ...
        sunlight.quad = new THREE.Mesh(new THREE.PlaneBufferGeometry(window.innerWidth, window.innerHeight), sunlight.materialGodraysGenerate);
...
engine3D.setDay = function (set) {
    if (set !== undefined) json.weather.day = set;
